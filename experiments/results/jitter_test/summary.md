...
Generated by `experiments/jitter_test.jl`. Measured result numbers below come from `metrics.csv`; setup values, sweep grids, and seeds are recorded in `config.toml`.
