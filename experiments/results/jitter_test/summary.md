...
The data-derived statement is therefore narrower than "narrow windows fail abruptly". Window-boundary collapse occurs at the measured window set {0.10}, while the paired-seed steep active-output reordering criterion is met at {0.25, 0.50, 1.00, 2.00, 4.00}. Panel C of `figure.png` shows both shapes on one axis, with dotted lines marking collapse rate.
